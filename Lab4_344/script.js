...
const modal = document.getElementById("myModal");
    ...
    openModalButton.addEventListener("click", () => {
      ...
      if (currentNumber730 > 0) {
        selectedProducts.push(`ขวดแดง สละ (ขวดยอดนิยมตลอดกาล) : ${currentNumber730} ชิ้น`);
      }
      if (currentNumber21 > 0) {
        selectedProducts.push(`ขวดเขียว ครีมโซดา (ขวดยอดนิยมตลอดกาล): ${currentNumber21} ชิ้น`);
      }
      if (currentNumber55 > 0) {
        selectedProducts.push(`ขวดเหลือง สับปะรด : ${currentNumber55} ชิ้น`);
      }
      if (currentNumber50 > 0) {
        selectedProducts.push(`ขวดม่วง องุ่น : ${currentNumber50} ชิ้น`);
      }
      ...
      const summ = (currentNumber730 * 60) + (currentNumber21 * 65) + (currentNumber55 * 70) + (currentNumber50 * 80);
      let final_summ = summ;
      let discountMessage = "";
      let priceBefMessage = "";
